...
**Arguments:** `carrying_capacity`, `mean_env`, `sd_env`, `spatial_auto_cor`, `phi`, `p_disturb`, `m_disturb`
...
Users can also define disturbance probability (`p_disturb`) and mortality (`m_disturb`). When disturbance occurs, all habitat patches are reduced by `m_disturb`. `m_disturb` can be identical or different across habitat patches.
